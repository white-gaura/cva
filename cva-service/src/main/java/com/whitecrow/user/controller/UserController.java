package com.whitecrow.user.controller;
...
import static com.whitecrow.constant.RedisConstant.USER_RECOMMENDATIONS;
...
public class UserController {
    ...
    public BaseResponse<Page<User>> recommendUsers(int pageSize, int  pageNum, HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        String redisKey = String.format(USER_RECOMMENDATIONS, loginUser.getId());
